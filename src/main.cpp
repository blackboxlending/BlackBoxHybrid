...
unsigned int nStakeMinAge = 360 * 60 * 60;
unsigned int nStakeMaxAge = 2160 * 60 * 60; // unlimited
...
const string strMessageMagic = "BlackBoxLending Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BlackBoxLending", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
unsigned char pchMessageStart[4] = { 0x02, 0x24, 0x35, 0x41 };
